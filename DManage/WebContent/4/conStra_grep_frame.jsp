...
%>
 <head>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $('#add').click(function() {
                    ...
                    document.frames['main'].location="conStra_grep_add.jsp?school_type="+valuschool+"&city_type="+valucity+"&grouptype="+valugrouptype;
                })
            });
            ...
            function getSelect(myForm, myName) {
                ...
                document.forms[myForm].action = "conStra_grep_frame.jsp";
    ...
    <div class="main_co">
        ...
        <form action="conStra_grep.jsp" target="main" method="post" name="search" style="margin:0">
