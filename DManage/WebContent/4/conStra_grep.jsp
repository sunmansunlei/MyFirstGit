...
<head>
    ...
    <script type="text/javascript">
        ...
        function del(i,name,grouptype){
            ...
            document.forms["mod"+i].action="conStra_grep_del.jsp";
        ...
        function modadvancesearch(ls_type,goupname,goupid,grouptype,school,loginname){
            ...
            parent.frames['main'].location="conStra_grep_edit.jsp?city_type="+ls_type+"&goupname="+goupname+"&id="+goupid+"&grouptype="+grouptype+"&school="+school+"&loginname="+loginname+"&grouptypeold="+grouptype;
...
<table width="99%"  align="center" border="0" cellpadding="0" cellspacing="1" class="tableform">
    ...
    <form  method="post" target="actions" name="mod<%=i%>">
        ...
        <tr bgcolor="#ffffff" > <input type="hidden" name="goupid" value="<%=ht.get("groupid")%>">
            ...
            <td align="center" class="block" height="30">
                <input type="hidden" name="loginname" class="b9" size="15" value="<%=loginname%>">
                <%=loginname%>
            </TD>
        ...
        <td  class="b9" colspan="7" height="20">
            <table width="100%" height="12">
                <tr>
                    ...
                    <td class="b9" align="right"  valign="middle"><%=Tools.getPageString(users.size(),iPageSize, iPageNum,"conStra_grep.jsp"+"?"+para+"&")%></td>
                </tr>
            </table>
        </td>
    </tr>
