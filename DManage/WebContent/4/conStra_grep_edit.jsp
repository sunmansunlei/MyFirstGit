...
<head>
    ...
    <script type="text/javascript">
        ...
        function modw(){
            ...
            document.forms["mod"].action="conStra_grep_edit_save.jsp?id=<%=id%>&oldgrouptype=<%=grouptypeold%>";
        ...
        function getSelect(myForm, myName) {
            ...
            document.forms[myForm].action = "conStra_grep_edit.jsp";
        ...
        function del(i,id,ls_type,grouptype,school){
            ...
            document.forms["mod"].action="conStra_grep_del_user.jsp?ids="+id+"&city_type="+ls_type+"&grouptype="+grouptype+"&school="+school;
            document.forms["mod"].submit();
        }
        ...
        function moduser(i,id,ls_type,school){
            ...
            document.forms["mod"].action="conStra_grep_mod_user.jsp?id="+id+"&city_type="+ls_type+"&school="+school+"&loginname="+loginname;
            document.forms["mod"].submit();
        }
        ...
        function advancesearch0() {
            ...
            if (a != null)  {
                document.location = "conStra_grep_edit.jsp?str_loginname=" + a + "&city_type=" + valucity + "&school=" + valuschool + "&grouptype=" + valugrouptype + "&goupname=" + goupname + "&loginname="+a+"&id=<%=id%>&grouptypeold=<%=grouptypeold%>";
            }
        }
        ...
        function adduser(ls_type,school){
            ...
            document.forms["mod"].action="conStra_grep_add_user.jsp?city_type="+ls_type+"&school="+school+"&loginname="+loginname;
            document.forms["mod"].submit();
        }
    </script>
    <style type="text/css">
