...
<form  target="actions" name="mod"  method="post" >
    <table width="80%" align="center"  border="0" cellpadding="0" cellspacing="1" class="tableform">
        ...
        <tr>
            <td class="title" width="220">控制策略名称</td>
            <td    class="block">
        ...
        <tr>
            ...
            <td    class="block">
                <select name="usb"  class="table_normal" style="border:1;font-size: 12px;width:220px">
                    <option value="0" <%if(hashtable.get("usb").equals("0")){%>selected="selected" <%}%>>禁用</option>
                    <option value="1" <%if(hashtable.get("usb").equals("1")){%>selected="selected" <%}%>>可用</option>
                </select></td>  </tr>
        <tr>
            ...
            <td  class="block" >
                <select name="wifi"  class="table_normal" style="border:1;font-size: 12px;width:220px" >
                    <option value="0" <%if(hashtable.get("wifi").equals("0")){%>selected="selected" <%}%>>禁用</option>
                    <option value="1" <%if(hashtable.get("wifi").equals("1")){%>selected="selected" <%}%>>可用</option>
                </select></td>
        </tr>
        <tr>
            ...
            <td  class="block" >
                <select name="ad">
                    <option value="0" <%if(hashtable.get("ad").equals("0")){%>selected="selected" <%}%>>禁用</option>
                    <option value="1" <%if(hashtable.get("ad").equals("1")){%>selected="selected" <%}%>>可用</option>
                </select>
            </td>
        </tr>
        <tr>
            ...
            <td  class="block" >
                <select name="addl">
                    <option value="0" <%if(hashtable.get("cservice").equals("0")){%>selected="selected" <%}%>>禁用</option>
                    <option value="1" <%if(hashtable.get("cservice").equals("1")){%>selected="selected" <%}%>>可用</option>
                </select>
            </td>
        </tr>
        <tr>
