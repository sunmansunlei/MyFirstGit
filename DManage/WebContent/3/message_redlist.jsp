...
<head>
    ...
    <script type="text/javascript">
        ...
        function del(i,name,grouptype){
            ...
            document.forms["mod"+i].action="message_redlist_del.jsp";
        ...
        function modadvancesearch(ls_type,goupname,goupid,grouptype,school,loginname){
            parent.frames['main'].location="message_redlist_edit.jsp?city_type="+ls_type+"&goupname="+goupname+"&id="+goupid+"&grouptype="+grouptype+"&school="+school+"&loginname="+loginname;
        ...
        <td  class="b9" colspan="6" height="20">
            <table width="100%" height="12">
                <tr>
                    ...
                    <td class="b9" align="right"  valign="middle"><%=Tools.getPageString(users.size(),iPageSize, iPageNum,"message_redlist.jsp"+"?"+para+"&")%></td>
                </tr>
            </table>
        </td>
    </tr>
