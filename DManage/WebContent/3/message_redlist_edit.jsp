...
<head>
    ...
    <script type="text/javascript">
        ...
        function modgroup(){
            ...
            document.forms["mod"].action="message_redlist_edit_ok.jsp?id=<%=id%>";
        ...
        function getSelect(myForm, myName) {
            ...
            document.forms[myForm].action = "message_redlist_edit.jsp";
        ...
        function deluser(i,id,ls_type,school){
            ...
            document.forms["mod"].action="message_redlist_del_user.jsp?ids="+id+"&city_type="+ls_type+"&school="+school;
            document.forms["mod"].submit();
        }
        ...
        function moduser(i,id,ls_type,school){
            ...
            document.forms["mod"].action="message_redlist_mod_user.jsp?id="+id+"&city_type="+ls_type+"&school="+school+"&loginname="+loginname;
            document.forms["mod"].submit();
        }
        ...
        function advancesearch0() {
            ...
            if (a != null)  {
                document.location = "message_redlist_edit.jsp?str_loginname=" + a + "&city_type=" + valucity + "&school=" + valuschool+ "&goupname=" + goupname + "&loginname="+a+"&id=<%=id%>";
            }
        }
        ...
        function adduser(ls_type,school){
            ...
            document.forms["mod"].action="message_redlist_add_user.jsp?city_type="+ls_type+"&school="+school+"&loginname="+loginname;
            document.forms["mod"].submit();
        }
    </script>
    <style type="text/css">
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td align="center">
                        <table width="100%">
                            <tr>
                                <td onclick="moduser('<%=i%>','<%=ht2.get("id")%>','<%=ls_type%>','<%=school%>')" align="center">
