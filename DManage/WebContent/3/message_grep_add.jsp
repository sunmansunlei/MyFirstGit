...
<%
    try {
        MessageGrep userStates = new MessageGrep();
...
<head>
    ...
    <script type="text/javascript">
        ...
        function addaa() {
            ...
            if (confirm("您确定新增消息分组吗？")) {
                document.forms["add"].action = "message_grep_add_save.jsp";
        ...
        function advancesearch() {
            ...
            if (a != null) {
                ...
                document.location = "message_grep_add.jsp?str_loginname=" + a + "&city_type=" + valucity + "&school_type=" + valuschool + "&group_type=" + valugrouptype + "&goupname_name=" + goupname;
            }
        }
        function ok() {
