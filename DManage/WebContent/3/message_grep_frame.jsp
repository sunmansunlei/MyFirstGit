...
%>
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    ...
                    $('#add').click(function() {
                        ...
                        //    return;
                        //}
                        document.frames['main'].location="message_grep_add.jsp?school_type="+valuschool+"&city_type="+valucity+"&grouptype="+valugrouptype;
                    })
                });
                ...
                function getSelect(myForm, myName) {
                    ...
                    document.forms[myForm].action = "message_grep_frame.jsp";
        ...
        <div class="main_co">
            ...
            <form action="message_grep.jsp" target="main" method="post" name="search" style="margin:0">
