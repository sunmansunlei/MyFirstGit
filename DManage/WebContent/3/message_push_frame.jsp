	...
	<head>
	    ...
	    <script type="text/javascript">
	        ...
	        $(document).ready(function() {
                ...
                var startyear = document.forms["search"].elements["startyear"].value;
	               ...
	               var endday = document.forms["search"].elements["endday"].value;
	                ...
	                document.frames['main'].location="message_push.jsp?school_type="+valuschool+"&city_type="+valucity+"&grouptype="+vagrouptype+"&msgsendtype="+vmsgsendtype+"&msgtype="+vmsgtype+"&startyear="+startyear+"&endyear="+endyear+"&startmonth="+startmonth+"&endmonth="+endmonth+"&startday="+startday+"&endday="+endday+"&msgname="+msgname;
	            })
	        });
	        ...
	        function getSelect(myForm, myName) {
	            ...
	            document.forms[myForm].action = "message_push_frame.jsp";
            ...
            function type3delete(){
                ...
                {
                    document.frames['main'].location="message_push_del_batch.jsp?school_type="+valuschool+"&city_type="+valucity+"&grouptype="+vagrouptype+"&msgsendtype="+vmsgsendtype+"&msgtype="+vmsgtype+"&startyear="+startyear+"&endyear="+endyear+"&startmonth="+startmonth+"&endmonth="+endmonth+"&startday="+startday+"&endday="+endday+"&strKey="+strKey;
                }
            }
	    </script>
	    <style type="text/css">
...
<div class="main_co">
    ...
    <form target="main" action="message_push_add.jsp" method="post" name="search" style="margin:0">
        <table cellpadding=2 cellspacing=1 border=0 >
            <tr>
				...
				<td align="center" class="block" height="30">
					<select name="msgsendtype" class="table_normal"  style="border:1;font-size: 12px;width:60px">
				        <option value="-1"></option>
            	...
            	<td align="center" class="block" height="30">
                <select name="msgtype"  class="table_normal" style="border:1;font-size: 12px;width:60px">
                	<option value="-1"></option>
	...
	<div class="main_iframe"><iframe name="main" width="100%" frameborder="0" height="360" src="../blank.htm"></iframe></div>
	</body>
</html>
<%
    } catch (Exception e) {
