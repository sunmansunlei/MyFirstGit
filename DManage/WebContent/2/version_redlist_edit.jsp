...
<head>
    ...
    <script type="text/javascript">
        ...
        function modgroup(){
            ...
            document.forms["mod"].action="version_redlist_edit_ok.jsp?id=<%=id%>";
        ...
        function advancesearch(i) {
           ...
           // var valugrouptype= document.forms['mod'].elements['grouptype'].options[document.forms['mod'].elements['grouptype'].selectedIndex].value;
            ...
            a = window.showModalDialog("query_user_share_frame.jsp?citycode="+valucity+"&school="+valuschool+"&group_type=1"+"&osid_id="+valuosid+"&accessid_id="+valuaccessid, 0, w_option);

            if (a != null)  {/*

                document.location = "version_redlist_edit.jsp?str_loginname=" + a + "&city_type=" + valucity + "&school=" + valuschool + "&grouptype=1"+ "&goupname=" + goupname + "&osid=" + valuosid + "&accessid=" + valuaccessid+"&loginname="+a+"&id=<%=id%>";
        ...
        function advancesearchw(i) {
            ...
            w_option = "dialogWidth:780px;dialogHeight:500px;help:No;resizable:No;status:No";
            a = window.showModalDialog("query_user_share_frame_add.jsp?citycode="+valucity+"&school="+valuschool+"&group_type=1"+"&osid_id="+valuosid+"&accessid_id="+valuaccessid, 0, w_option);

            if (a != null)  {
                document.location = "version_redlist_edit.jsp?str_loginname=" + a + "&city_type=" + valucity + "&school=" + valuschool+ "&goupname=" + goupname + "&osid=" + valuosid + "&accessid=" + valuaccessid+"&loginname="+a+"&id=<%=id%>";
            }
        }
        function getSelect(myForm, myName) {
            ...
            document.forms[myForm].action = "version_redlist_edit.jsp";
        ...
        function deluser(i,id,ls_type,grouptype,school){

            if(!confirm("确认要删除用户吗？")){
                return;
            }
            document.forms["mod"].action="version_redlist_del_user.jsp?ids="+id+"&city_type="+ls_type+"&school="+school;
            document.forms["mod"].submit();
        }
        ...
        function moduser(i,id,ls_type,school){
            ...
            document.forms["mod"].action="version_redlist_mod_user.jsp?id="+id+"&city_type="+ls_type+"&school="+school+"&loginname="+loginname;
            document.forms["mod"].submit();
        }
        ...
        function adduser(ls_type,school){
            ...
            document.forms["mod"].action="version_redlist_add_user.jsp?city_type="+ls_type+"&school="+school+"&loginname="+loginname;
            document.forms["mod"].submit();
        }
        ...
        function advancesearch0() {
            ...
            if (a != null)  {
                document.location = "version_redlist_edit.jsp?str_loginname=" + a + "&city_type=" + valucity + "&school=" + valuschool + "&grouptype=1"+ "&goupname=" + goupname + "&osid=" + valuosid + "&accessid=" + valuaccessid+"&loginname="+a+"&id=<%=id%>&grouptypeold=1";
            }
        }
    </script>
    <style type="text/css">
...
<table width="80%" align="center"  border="0" cellpadding="0" cellspacing="1" class="tableform">
    ...
    <tr>  <td class="title">组类别</td>
        <td class="block" height="30">
            <select name="grouptype" disabled="disabled" class="table_normal" style="border:1;font-size: 12px;width:180px" onchange="okfg();">
    ...
    <tr id="addtable">
        ...
        <td  class="block" height="30" >
            <table  border="0" cellspacing="0" cellpadding="0" id="ed0">
                <tr>
                    <TD class="nm_td size20"><input type="text" name="loginname" class="b9" size="15" maxlength="30" value="<%=str%>"></TD>
            ...
            <table align="left"  border="0" cellpadding="0" cellspacing="1" class="tableform" id="ed12">
                ...
                <tr>
                    ...
                    <td align="center" class="block" height="30">
                        <table  border="0" cellspacing="0" cellpadding="0" >
                            <tr>
                                <TD class="nm_td size20"><input type="text" name="loginnamew" class="b9" size="15" maxlength="30" value="<%=str%>"></TD>
                ...
                <td align="center" class="block" height="30">
                    <table  border="0" cellspacing="0" cellpadding="0" >
                        <tr>
                            <TD class="nm_td size20"><input type="text" name="loginname<%=i%>" class="b9" size="15" maxlength="30" value="<%=ht2.get("loginname")%>"></TD>
                ...
                <td align="center">
                    <table width="100%">
                        <tr>
                            ...
                            <td onclick="deluser(<%=i%>,'<%=ht2.get("id")%>','<%=ls_type%>','<%=grouptype%>','<%=school%>')" align="center">
