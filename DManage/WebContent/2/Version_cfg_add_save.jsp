...
<%
    ...
    if (ii==66){
        ii = user.add(userInfo.get("login").toString(), osid, accessid, stdver, chidver, filename,pah,ppath, filemd5, filetmppath, filetype, opetype, opesec, opeworkpath, opetargetpath, opecmd);
    }else {
        ii=-99;
    }
